    ...
    # --- main chat UI ---
        ...
        if st.session_state.trigger_ai_reply and st.session_state.user_count <= 6:
            ...
            for i, ai_name in enumerate(ai_names):
                if i == 0:
                    time.sleep(random.uniform(1.2, 2.2))  # "thinking" delay before the 1st agent only
            ...
            bigfive_followup_styles = {
                "HO": [
                    ...
                    "Make an offbeat connection and invite others into the main idea.",
                    "Bring up a new angle and casually bring {name} into the mix."
                ],
                "LO": [
                    "Stick to something practical and casually tag {name} for thoughts on the topic.",
                ...
                "LC": [
                    ...
                    "Admit to being a bit off topic and pull others back in with humour.",
                    "Say something fun, and use all lowercase."
                ],
                "HE": [
                    "Say something fun or expressive.",
                    "Throw out a cheerful message and draw others into the topic.",
            ...
            with st.spinner(f"{followup_speaker} is typing..."):
                ...
                followup_prompt = (
                    ...
                    "Keep you response to 1 to 2 sentences. "
