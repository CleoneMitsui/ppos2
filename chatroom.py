...
def render_chat():
    ...
    # --- main chat UI ---
        ...
        # get main.py to take over and move to google sheet and redirect to prolific
    ...
    # user_msg_count = sum(1 for m in st.session_state.messages if m["role"] == "user")
    # if user_msg_count >= 5 and not st.session_state.get("final_block_executed", False):
    #     st.session_state.final_block_executed = True
    #     st.session_state.page = "post"
    #     st.rerun()
