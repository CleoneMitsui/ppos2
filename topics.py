...
topics = {
    "guns": {
        "liberal": [
            ...
            ("Olivia", "It breaks my heart every time there’s another school shooting. How many families have to suffer before we act?"),
    ...
    "immigration": {
        ...
        "conservative": [
            ...
            ("Mark", "Right? Strong borders and fair processes can coexist. But ignoring risks is reckless. Anyway, welcome to the group, {{user_name}}. What are your thoughts on this?")
        ]
    },
    "abortion": {
        "liberal": [
            ...
            ("Mark", "Exactly, removing access doesn’t reduce abortions, it just makes them more dangerous. Anyway, welcome to the group, {{user_name}}. What are your thoughts on this?")
        ],
        "conservative": [
    ...
    "vaccines": {
        ...
        "conservative": [
            ...
            ("Mark", "Mandates destroy trust. We need informed consent, not forced compliance. Anyway, welcome to the group, {{user_name}}. What are your thoughts on this?")
        ]
    },
    "gender": {
        "liberal": [
            ("Curtis", "Now people are mad about kids learning what gender identity? Seriously?"),
            ("Olivia", "Understanding gender diversity helps kids navigate the world with empathy. It’s not political, it’s human."),
            ("Mark", "Agreed, education isn’t indoctrination...it’s about expanding awareness. Anyway, welcome to the group, {{user_name}}. What are your thoughts on this?")
        ],
        "conservative": [
